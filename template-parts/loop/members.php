    ...
    <?php if (has_post_thumbnail()): ?>
      <figure class="ratio m-0 ratio-1x1">
        <img src="<?php echo esc_url(get_the_post_thumbnail_url($post_id, 'medium')); ?>"
          class="card-img-top object-fit-cover img-fluid" alt="<?php the_title_attribute(); ?>">
      </figure>
    <?php endif; ?>
      ...
      <div class="modal-body modal-member-body">
        <div class="row">
          <div class="col-md-4">
            <?php if (has_post_thumbnail()): ?>
              <figure class="ratio ratio-1x1 m-0">
                <img src="<?php echo esc_url(get_the_post_thumbnail_url($post_id, 'medium')); ?>"
                  class="img-fluid rounded h-100 object-fit-cover mb-3" alt="<?php the_title_attribute(); ?>">
              </figure>
            <?php endif; ?>
          </div>
          ...
          <div class="col-md-8">
            ...
            <p class="modal-member-role"><?php echo esc_html(get_the_excerpt()); ?></p>
            <div class="modal-member-content"><?php the_content(); ?></div>

            <div class="modal-social mt-3 d-flex gap-3 flex-wrap">
              <?php if ($instagram): ?>
                <a href="<?php echo esc_url($instagram); ?>" target="_blank"><i class="fab fa-instagram fa-lg"></i></a>
              <?php endif; ?>
